  ...
  return (
    <div style={container}>
      <div style={card}>
        ...
        <div style={footer}>
          계정이 없으신가요? <Link to="/signup" style={link}>회원가입</Link>
        </div>
      </div>
    </div>
  );
...
const label: React.CSSProperties = { display: "block", fontSize: 13, fontWeight: 700, color: "#4b5563", marginBottom: 6 };
const input: React.CSSProperties = {
  width: "100%", padding: 14, borderRadius: 12, border: "1px solid #e5e7eb",
  background: "#f9fafb", fontSize: 15, outline: "none", transition: "border 0.2s"
};

const btn: React.CSSProperties = {
  width: "100%", padding: 16, borderRadius: 14, border: 0, marginTop: 8,
  background: "var(--primary)", color: "white", fontSize: 16, fontWeight: 700,
